        ...
        <header className="bg-black">
            <div className="container mx-auto flex justify-between">
                ...
                <div className="inline-flex py-3 px-3 my-6">
                    <SocialIcon url="https://twitter.com/lovely Marg" className="mr-4" target="_blank" fgColor="#fff" style={{ height: 35, width: 35}} />
                    <SocialIcon url="https://youtube.com/Marjorie Ciceron" className="mr-4" target="_blank" fgColor="#fff" style={{ height: 35, width: 35}} />
